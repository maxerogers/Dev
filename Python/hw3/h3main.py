...
## I was not able to find a 6x6 puzzle that this algorithm couldn't solve. I wanted to implement a second layer which would go make a copy of the unsolved squares storing their intial data. Then it would brute force a solution trying every possible combination
# example:
#   say square 3A and 4B still had 12 as a value. To continue through the iteration the program would assign 3A 1 and 4B 2. Then continuing this process guess until it reached the end :'( but i didn't want to put in untested code 
